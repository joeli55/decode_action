...
class _0x1af457 extends _0x3d6a2f {
  ...
  async sign_doTask(_0x4abf2f, _0x493683, _0x523ec5 = {}) {
    try {
      ...
      let _0xb86fd5 = _0x18a085,
        {
          result: _0xc246cd
        } = await this.request(_0xb86fd5),
  ...
  async game_login(_0x5cf193, _0x4a1e77 = {}) {
    try {
      ...
      let _0x1841b6 = _0x235784,
        {
          result: _0x19ad7f
        } = await this.request(_0x1841b6),
  ...
  async woread_getSeeVideoAddNumber(_0x3a2f66 = {}) {
    try {
      ...
      let _0x89125c = {
        ...
        {
          result: _0x3e0978
        } = await this.woread_api(_0x89125c),
  ...
  async woread_addUserSeeVideo(_0x20d0ff = {}) {
    try {
      ...
      let _0xe6f4cc = {
        ...
        {
          result: _0x303fb6
        } = await this.woread_api(_0xe6f4cc),
  ...
  async woread_getActivityNumber(_0x28ade4 = {}) {
    try {
      ...
      let _0x449229 = {
        ...
        {
          result: _0x3181dc
        } = await this.woread_api(_0x449229),
  ...
  async woread_doDraw(_0x20dcc4 = {}) {
    try {
      ...
      let {
        result: _0x2a1134
      } = await this.woread_api(_0x255b2f);
  ...
  async woread_queryTicketAccount(_0x531dc3 = {}) {
    try {
      ...
      let _0xc1eb0d = {
        ...
        {
          result: _0x470d85
        } = await this.woread_api(_0xc1eb0d),
  ...
  async rabblit_queryActivityData(_0x24d02f = {}) {
    try {
      ...
      let _0xd34fbe = {
        ...
        {
          result: _0x299cd5
        } = await this.woread_api(_0xd34fbe),
  ...
  async rabblit_joinRuning(_0x4909f0 = {}) {
    ...
    try {
      ...
      let _0x59dd30 = {
        ...
        {
          result: _0x49a8bf
        } = await this.woread_api(_0x59dd30),
  ...
  async rabblit_wakeRabbit(_0x3a8596 = {}) {
    try {
      ...
      let {
        result: _0x1cb452
      } = await this.woread_api(_0x24cef2);
      this.t_woread_draw = Date.now();
  ...
  async rabblit_finishActivity(_0x574a56 = {}) {
    try {
      ...
      let {
        result: _0x471e25
      } = await this.woread_api(_0x26a507);
      this.t_woread_draw = Date.now();
  ...
  async moonbox_queryCurTaskStatus(_0x473c55 = {}) {
    try {
      ...
      let _0x453d94 = {
        ...
        {
          result: _0xe87ba0
        } = await this.woread_api(_0x453d94),
  ...
  async moonbox_completeActiveTask(_0x32bb63, _0x100a4e = {}) {
    try {
      ...
      let _0xfd39cf = {
        ...
        {
          result: _0x33121a
        } = await this.woread_api(_0xfd39cf),
  ...
  async moonbox_queryActiveTaskList(_0x2cacbe = {}) {
    try {
      ...
      let _0x12fd9b = {
        ...
        {
          result: _0x5aa8f9
        } = await this.woread_api(_0x12fd9b),
  ...
  async moonbox_receiveActiveTask(_0x28d733, _0x3a5e9d = 0, _0x284d10 = {}) {
    try {
      ...
      let _0x39ec60 = {
        ...
        {
          result: _0x34e178
        } = await this.woread_api(_0x39ec60),
  ...
  async moonbox_queryReadStatus(_0x45ba6e = {}) {
    try {
      ...
      let _0x1a39b6 = {
        ...
        {
          result: _0x1e6395
        } = await this.woread_api(_0x1a39b6),
  ...
  async moonbox_drawReadActivePrize(_0x13ea59 = {}) {
    try {
      ...
      let _0x5d1b4a = {
        ...
        {
          result: _0x42e68b
        } = await this.woread_api(_0x5d1b4a),
  ...
  try {
    let _0x4d5041 = {
      ...
      },
      {
        ...
        result: _0x5efd7f
      } = await _0x356155.request(_0x4d5041);
    if (_0x174eb8 != 200) {
  ...
  try {
    let _0x5bc522 = {
      ...
      },
      {
        ...
        result: _0x48c0f2
      } = await _0x356155.request(_0x5bc522);
    if (_0x201ec9 != 200) {
      return Promise.resolve();
    }
    if (_0x48c0f2?.["code"] == 0) {
      ...
      if (_0x48c0f2?.["moonbox"]) {
        _0x9a005.moonbox = _0x48c0f2?.["moonbox"];
      }
    }
  } catch (_0x49366d) {
...
function _0x857d9a(_0x1e9549) {
  return new class {
    ...
    log(_0x247ae9, _0x5366d5 = {}) {
      ...
      Object.assign(_0x3c7d74, _0x5366d5);
      if (_0x3c7d74.time) {
        let _0x242f9d = _0x3c7d74.fmt || "hh:mm:ss";
        _0x247ae9 = "[" + this.time(_0x242f9d) + "]" + _0x247ae9;
      }
      if (_0x3c7d74.notify) {
        this.notifyStr.push(_0x247ae9);
      }
      if (_0x3c7d74.console) {
    ...
    async threadTask(_0x1be88d, _0x2592a0) {
      ...
      while (_0x2592a0--) {
        _0x253c91.push(this.threads(_0x1be88d, _0x443423));
      }
