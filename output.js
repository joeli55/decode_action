...
(function (_0x1398c0) {
  ...
  class _0x252e78 {
    ...
    ["log"](_0x1b8189, _0x9c4426 = {}) {
      ...
      if (this.index) {
        _0x1ac632 += "[号账".split("").reverse().join("") + _0x1a907b.padStr(this.index, _0xad7cd9) + "]";
      }
      if (this.name) {
        _0x1ac632 += "[" + this.name.slice(0, 3) + "****".split("").reverse().join("") + this.name.slice(-4) + "]";
      }
    ...
    async ["parseCookies"](_0x1ece13, _0x3c1e28) {
      ...
      _0x2ea51f.forEach(_0x167de8 => {
        ...
        if (_0x167de8.includes("=")) {
          ...
          if (!_0x15b1dc.toLowerCase().includes("path") && !_0x15b1dc.toLowerCase().includes("seripxe".split("").reverse().join("")) && !_0x15b1dc.toLowerCase().includes("eruces".split("").reverse().join("")) && !_0x15b1dc.toLowerCase().includes("etisemas".split("").reverse().join(""))) {
            _0x4cba26[_0x15b1dc] = _0x59adc6;
          }
        }
      });
      if (_0x3c1e28) {
    ...
    async ["request"](_0x190a2b) {
      ...
      if (_0x190a2b?.["ckvalue"]) {
        _0x190a2b.headers = _0x190a2b?.["headers"] || {
      ...
      while (_0x3192a9 < _0x80a14f) {
        try {
          ...
          await new Promise(async _0x1e79c1 => {
            ...
            _0x22e3f1 = 17;
            if (_0x190a2b?.["ckvalue"]) {
              _0x190a2b.headers = _0x190a2b?.["sredaeh".split("").reverse().join("")] || {
            ...
            try {
              ...
              if (_0x154715.response?.["statusCode"] == 412) {
                ...
                if (_0x154715.response && _0x154715.response.headers) {
                  ...
                  _0x594dfa = 13;
                  if (Array.isArray(_0x5cc77d)) {
                    _0x2ec177 = _0x5cc77d.map(_0x259e52 => _0x259e52.split(";")[0]).join("; ");
                  }
                }
                ...
                _0x194be3 = _0x154715;
                _0x1983cd = _0x154715.response;
                _0x16d92d = _0x154715.response?.["code"] || "";
                _0x3dc0a8 = _0x154715.response?.["name"] || "";
              }
            }
            _0x1e79c1();
          });
          if (_0x247d00) {
            this.log("[" + _0x4dd0e7 + "(时超求请]".split("").reverse().join("") + _0x34816a / 1000 + "第试重，)秒".split("").reverse().join("") + _0x3192a9 + "次");
          } else {
            if (_0x45beb9.includes(_0x16d92d)) {
              this.log("[" + _0x4dd0e7 + "[误错求请]".split("").reverse().join("") + _0x16d92d + "[]".split("").reverse().join("") + _0x3dc0a8 + "]");
              if (_0x194be3?.["message"]) {
                console.log(_0x194be3.message);
              }
              break;
            } else {
              if (_0x268e93.includes(_0x3dc0a8)) {
                this.log("[" + _0x4dd0e7 + "[误错求请]".split("").reverse().join("") + _0x16d92d + "][" + _0x3dc0a8 + "第试重，]".split("").reverse().join("") + _0x3192a9 + "次");
              } else {
                if (_0xb9ee29.includes(_0x16d92d)) {
                  this.log("[" + _0x4dd0e7 + "[误错求请]".split("").reverse().join("") + _0x16d92d + "][" + _0x3dc0a8 + "]，重试第" + _0x3192a9 + "次");
                } else {
                  if (_0x1983cd?.["edoCsutats".split("").reverse().join("")] == 412) {
                    break;
                  }
                  let _0x1ebbf7 = _0x1983cd?.["edoCsutats".split("").reverse().join("")] || "",
                    _0x359dc7 = _0x1ebbf7 / 100 | 0;
                  if (_0x1ebbf7) {
                    if (_0x359dc7 > 3 && !_0x4a98af.includes(_0x1ebbf7)) {
                      if (_0x1ebbf7) {
                        this.log("[求请".split("").reverse().join("") + _0x4dd0e7 + "]返回[" + _0x1ebbf7 + "]");
                      } else {
                        this.log("请求[" + _0x4dd0e7 + "[误错]".split("").reverse().join("") + _0x16d92d + "][" + _0x3dc0a8 + "]");
                      }
                    }
                    if (_0x359dc7 <= 4) {
                      break;
                    ...
                    this.log("请求[" + _0x4dd0e7 + "]错误[" + _0x16d92d + "][" + _0x3dc0a8 + "]");
                  }
                }
              }
            }
          ...
          if (_0x1b27b0.name == "rorrEtuoemiT".split("").reverse().join("")) {
            this.log("[" + _0x4dd0e7 + "第试重，时超求请]".split("").reverse().join("") + _0x3192a9 + "次");
          } else {
            this.log("[" + _0x4dd0e7 + "(误错求请]".split("").reverse().join("") + _0x1b27b0.message + "第试重，)".split("").reverse().join("") + _0x3192a9 + "次");
          }
        }
      }
      const _0x5c5b0c = {
      ...
      if (_0x1983cd == null) {
        return Promise.resolve(_0x5c5b0c);
      }
      let {
  ...
  class _0x173a90 extends _0x2ecb9a {
    ...
    ["load_token"]() {
      let _0x40ebac = false;
      if (_0x4f8ac1[this.name]) {
        this.userId = _0x4f8ac1[this.name].userId;
        this.token = _0x4f8ac1[this.name].token;
        this.log("nekot存缓到取读".split("").reverse().join(""));
        _0x40ebac = true;
      }
      return _0x40ebac;
    }
    ...
    ["encode_password"]() {
      let _0x5c8413 = this.passwd.split("");
      for (let _0x4fd72e in _0x5c8413) {
        _0x5c8413[_0x4fd72e] = String.fromCharCode(_0x5c8413[_0x4fd72e].charCodeAt(0) + 2);
      }
      return _0x5c8413.join("");
            ...
            "json": {
              ...
              "content": {
                ...
                "fieldData": {
                  ...
                  "authentication": this.encode_password()
                }
              }
            }
          },
    ...
    async ["get_ticket"](_0x3407e5 = {}) {
      ...
      try {
        ...
        if (!_0x3dbd0c) {
          !_0x3407e5.retry && (await this.login()) ? (_0x3407e5.retry = true, _0x3dbd0c = await this.get_ticket(_0x3407e5)) : (this.log("没有获取到ticket[" + _0x61cf7a + "]: "), _0x4d1ded && this.log(" :".split("").reverse().join("") + JSON.stringify(_0x4d1ded)));
        }
      } catch (_0x47f1aa) {
    ...
    async ["get_rsValue"](_0x293dc9 = {}) {
      ...
      try {
        ...
        if (_0x45a4fc && _0x45a4fc["set-cookie"]) {
          ...
          if (Array.isArray(_0x5e227b)) {
            _0x13bf8e = _0x5e227b.map(_0x13a5c4 => _0x13a5c4.split(";")[0]).join("; ");
          }
        }
            ...
            for (let _0x16bb06 of _0x49f4fc?.["atad".split("").reverse().join("")]?.["zib".split("").reverse().join("")]?.["adItems"] || []) {
              if (["0", "1"].includes(_0x16bb06?.["taskState"])) {
                switch (_0x16bb06.contentOne) {
                  case "3":
                    {
                      if (_0x16bb06?.["dIdrawer".split("").reverse().join("")]) {
                        await this.receiveReward(_0x16bb06);
                      }
                      break;
                    }
                  case "5":
    ...
    async ["receiveReward"](_0x5b0aef, _0x4a06a5 = {}) {
      ...
      try {
        ...
        if (_0x19bcfa == 0) {
          this.log("[务任取领".split("").reverse().join("") + _0x298887 + "]奖励成功: " + _0x360d46?.["gsMtluoser".split("").reverse().join("")]);
        } else {
    ...
    async ["openMsg"](_0x3f3428, _0x21565e = {}) {
      ...
      try {
        ...
        if (_0x5edf25 == 0) {
          this.log("完成任务[" + _0x559622 + "]成功: " + _0x3fcc57?.["resoultMsg"]);
        } else {
    ...
    async ["polymerize"](_0x47b1b0, _0x2602a8 = {}) {
      ...
      try {
        ...
        if (_0x8e8602 == 0) {
          this.log("[务任成完".split("").reverse().join("") + _0x10342e + " :功成]".split("").reverse().join("") + _0x1d8e9c?.["resoultMsg"]);
        } else {
      ...
      try {
        ...
        if (_0x446a1b?.["currentLevel"]) {
          ...
          for (let _0x25f158 of _0x446a1b[_0xfc6c13] || []) {
            ...
            if ((_0x59f64f?.["match"](new RegExp("\\d+元话费", "")) || _0x59f64f?.["hctam".split("").reverse().join("")](new RegExp("豆金+d\\享专".split("").reverse().join(""), ""))) && (await this.getConversionRights(_0x25f158, _0x3fe3bd))) {
              _0x3fe3bd = true;
            }
          }
        } else {
    ...
    async ["conversionRights"](_0x4d2734, _0x3840bb = {}) {
      ...
      try {
        ...
        if (_0x7effe1 == 0) {
          this.log("兑换权益[" + _0x10bd41 + "功成]".split("").reverse().join(""));
        } else {
    ...
    async ["codeToken"](_0xdedb3c, _0xcf349 = {}) {
      ...
      try {
        ...
        if (_0x2ec0e9 == 0) {
          this.xtoken = _0x5db701?.["data"]?.["nekot".split("").reverse().join("")];
    ...
    async ["watchLive"](_0x37f1a7, _0x3101aa, _0x40985a = {}) {
      ...
      try {
        ...
        if (_0x54187e == 0) {
          this.log("观看直播[" + _0x37f1a7 + "功成]".split("").reverse().join(""));
          await this.watchLiveInit();
        } else {
    ...
    async ["sharingGetGold"](_0x280742 = {}) {
      ...
      try {
        ...
        if (_0x7781f1 == "0000") {
          this.log("功成享分".split("").reverse().join(""));
        } else {
    ...
    async ["month_jml_check"](_0x3a5e59, _0x510f6e = {}) {
      ...
      try {
        ...
        if (_0x4206ab == 0) {
          this.jml_tokenFlag = _0x5a7a54?.["atad".split("").reverse().join("")]?.["flag"];
          this.log("见面礼 " + _0x5a7a54.resoultMsg);
          await this.month_jml_receive(_0x3a5e59);
        } else {
    ...
    async ["month_jml_receive"](_0x41871e, _0x33741d = {}) {
      ...
      try {
        ...
        if (_0x85b1d5 == 0) {
          this.log("见面礼:" + _0x44ffb4?.["resoultMsg"]);
        } else {
    ...
    async ["month_jml_addVideoCount"](_0x3588dd, _0x2e8637, _0x43a1b7 = {}) {
      ...
      try {
        ...
        if (_0x3c6225 == 0) {
          this.log("[频视看".split("").reverse().join("") + _0x2e8637 + "]得抽奖机会成功");
        } else {
    ...
    async ["month_jml_refresh"](_0x336f0c, _0x4fea48 = {}) {
      ...
      try {
        ...
        if (_0xe586bc == "0") {
          this.log("见面礼包领取到:" + _0x1bde01.data.map(_0xd849f5 => _0xd849f5.prizeName) || []);
        } else {
    ...
    async ["queryInfo"](_0x5196aa = {}) {
      ...
      try {
        ...
        if (_0x3fcf26 == 0) {
          this.coin = _0x1609b1?.["biz"]?.["latoTtnuoma".split("").reverse().join("")] || this.coin;
  ...
  async function _0x42f36f(_0x3c60e7 = 0) {
    ...
    try {
      ...
      if (_0x5cd022 != 200) {
        _0x3c60e7++ < _0x503087 && (_0x27f4b7 = await _0x42f36f(_0x3c60e7));
        return _0x27f4b7;
      }
      if (_0x198999?.["edoc".split("").reverse().join("")] == 0) {
        ...
        if (_0x198999?.["gsMnommoc".split("").reverse().join("")] && _0x198999.commonMsg.length > 0) {
          _0x1a907b.log(_0x198999.commonMsg.join("\n") + "\n");
        }
        ...
        if (_0x3c60e7++ < _0x503087) {
          _0x27f4b7 = await _0x42f36f(_0x3c60e7);
        }
      }
    } catch (_0xb3a78e) {
  ...
  function _0xf189dd(_0x58fdd8) {
    return new class {
      ...
      ["log"](_0x3a25ce, _0x250d9c = {}) {
        ...
        if (_0x53456a.console) {
          console.log(_0x3a25ce);
        }
      }
      ["get"](_0x175a36, _0x26ff7a, _0x222b0e = "") {
        ...
        if (_0x745ed7 === 412) {
          ...
          if (_0x51e64 == undefined) {
            _0x51e64 = _0x3b0b0e.parseFromString(_0x175a36.response.body, "application/xml");
          }
          var _0x2ea96e = 15;
        ...
        if (_0x175a36?.["hasOwnProperty"](_0x26ff7a)) {
          _0x745ed7 = _0x175a36[_0x26ff7a];
        }
        return _0x745ed7;
      }
      ["pop"](_0x4ce15d, _0x2120b0, _0x272aea = "") {
        let _0x3af129 = _0x272aea;
        if (_0x4ce15d?.["ytreporPnwOsah".split("").reverse().join("")](_0x2120b0)) {
          _0x3af129 = _0x4ce15d[_0x2120b0];
          delete _0x4ce15d[_0x2120b0];
        }
        return _0x3af129;
      }
      ["copy"](_0x3d5675) {
      ...
      ["time"](_0x49ad16, _0x2b5063 = null) {
        ...
        if (new RegExp(")+y(".split("").reverse().join(""), "").test(_0x49ad16)) {
          _0x49ad16 = _0x49ad16.replace(RegExp.$1, (_0x31a923.getFullYear() + "").substr(4 - RegExp.$1.length));
        }
        for (let _0x301ea9 in _0x55fc08) if (new RegExp("(" + _0x301ea9 + ")").test(_0x49ad16)) {
          _0x49ad16 = _0x49ad16.replace(RegExp.$1, 1 == RegExp.$1.length ? _0x55fc08[_0x301ea9] : ("00" + _0x55fc08[_0x301ea9]).substr(("" + _0x55fc08[_0x301ea9]).length));
        }
        return _0x49ad16;
      }
      async ["showmsg"]() {
      ...
      ["str2json"](_0x45d5f2, _0x2ce388 = false) {
        ...
        for (let _0x576f5e of _0x45d5f2.split("&")) {
          ...
          if (_0x2ce388) {
            _0x1775cc = decodeURIComponent(_0x1775cc);
          }
      ...
      ["randomPattern"](_0x17c712, _0x20d7b2 = "abcdef0123456789") {
        ...
        for (let _0x437e45 of _0x17c712) {
          if (_0x437e45 == "x") {
            _0x1e24a4 += _0x20d7b2.charAt(Math.floor(Math.random() * _0x20d7b2.length));
          } else {
      ...
      ["normalize_time"](_0x52a126, _0xea5f47 = {}) {
        ...
        if (_0x2a4248 > _0x54f8e5) {
          _0x52a126 = _0x52a126.slice(0, 13);
        }
      ...
      async ["wait_until"](_0x549baf, _0xbd7457 = {}) {
        ...
        if (typeof _0x549baf == "string" && _0x549baf.includes(":")) {
          if (_0x549baf.includes("-")) {
            _0x549baf = new Date(_0x549baf).getTime();
          } else {
      ...
      async ["wait_gap_interval"](_0x3610c9, _0x1513c8) {
        ...
        if (_0x4fcaad < _0x1513c8) {
          await this.wait(_0x1513c8 - _0x4fcaad);
        }
      }
    }(_0x58fdd8);
  }
